    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-8 text-gray-700">
        ...
        <div className="z-20 flex justify-center ">
          <h2 className=" text-lg md:text-2xl font-medium px-6 pt-2 rounded-t-2xl shadow-[0_-8px_10px_-2px_rgba(0,0,0,0.1)] bg-white">
            Resumo do mês
          </h2>
        </div>

        <div className="bg-white rounded-2xl shadow p-6 mb-6 z-10">
